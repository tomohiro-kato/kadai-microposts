...
ActiveRecord::Schema.define(version: 20190129154419) do
  ...
  create_table "okinis", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "user_id"
    t.integer  "microposts_id"
    t.datetime "created_at",    null: false
    t.datetime "updated_at",    null: false
    t.index ["microposts_id"], name: "index_okinis_on_microposts_id", using: :btree
    t.index ["user_id"], name: "index_okinis_on_user_id", using: :btree
  end
  ...
  add_foreign_key "okinis", "microposts", column: "microposts_id"
  add_foreign_key "okinis", "users"
